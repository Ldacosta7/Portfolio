...
<head>
    ...
    <title>Lucas DA COSTA - Comment me contacter ?</title>
</head>
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary dark" data-bs-theme="dark">
      ...
      <div class="container">
        ...
        <div class="row">
            <h4 style="text-align:center">Dites-moi tout ! Je vous écoute.</h4>
        </div>
      ...
      <footer>
        <div class="arrow">
          <a href="realisation.html"><img src="images/left-arrow.png" alt="right-arrow" width="50" height="50"></a>
        </div>
      </footer>
</body>
</html>